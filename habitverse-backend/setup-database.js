...
const setupDatabase = async () => {
  console.log('🚀 Setting up HabitVerse Database...');
  ...
  try {
    ...
    await connection.execute(`CREATE DATABASE IF NOT EXISTS ${process.env.DB_NAME || 'habitverse_db'} CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci`);
    ...
    await db.schema.createTable('habit_checks', (table) => {
      ...
      table.index(['habit_id', 'date_checked']);
    });
